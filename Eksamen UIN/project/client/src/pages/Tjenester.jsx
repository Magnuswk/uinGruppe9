    ...
    return (
        <>
            ...
            <Artikkelmain>
                ...
                <h2>Containerleie</h2>
                <p>På siden for <NavLink to="/Containerleie">Containerleie</NavLink> Kan du leie en container hos oss!</p>
                <h2>Avløpsrens</h2>
                <p>På siden for <NavLink to="Avløpsrens">Avløpsrens</NavLink> kan du leie oss inn til å fikse tette rør</p>
                <h2>Olje og Fettutskilling</h2>
                <p>Dette er siden for <NavLink to="/Oljeogfettutskilling">Olje og Fettutskilling</NavLink></p>
                <h2>Gravesuger</h2>
                <p>Her kan du leie en <NavLink to="/Gravesuger">Gravesuger</NavLink></p>
                <h2>Bestilling og Henting av Farlig Avfall</h2>
                <p>Her kan du bestille <NavLink to="/bestillingoghentingavfarligavfall">Henting av Farlig Avfall</NavLink></p>
            </Artikkelmain>
        </>
    )
}
